...
import '../../components/dream_sketch_shape_painter.dart';
import 'dream_sketch_shape_drawing_logic.dart';
class DreamSketchShapeDrawingView
    extends GetView<DreamSketchShapeDrawingLogic> {
  const DreamSketchShapeDrawingView({super.key});
  @override
  ...
  Widget _buildShapeSelector() {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: DreamSketchShapeInfo.shapes.length,
        itemBuilder: (_, i) => _buildShapeItem(i),
      ),
    );
  }
  Widget _buildShapeItem(int index) {
    final shape = DreamSketchShapeInfo.shapes[index];
    return Obx(() {
      final isSelected = controller.selectedIndex.value == index;
      return GestureDetector(
        onTap: () => controller.onShapeSelect(index),
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                ...
                height: 40.w,
                child: CustomPaint(
                  painter: DreamSketchShapePainter(
                    shape.type,
                    strokeColor: isSelected
                        ? const Color(0xFF6A5ACD)
                        : const Color(0xFF4C3D9C),
                  ),
                ),
              ),
              SizedBox(height: 6.h),
                        ...
                        child: Opacity(
                          ...
                          child: ColorFiltered(
                            ...
                            child: SizedBox.expand(
                              child: CustomPaint(
                                painter: DreamSketchShapePainter(
                                  DreamSketchShapeInfo.shapes[idx].type,
                                  strokeColor: const Color(0xFF4C3D9C),
                                  strokeWidth: 4,
                                ),
                              ),
                            ),
